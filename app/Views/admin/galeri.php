...
<head>
    ...
    <title>Galeri | SMK INFORMATIKA ALHILAAL KAMAL</title>
    ...
    <!-- Facebook -->
    <meta property="og:url" content="https://themewagon.github.io/windster/users/list/">
                ...
                <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                    <div class="flex-1 px-3 bg-white divide-y space-y-1">
                        <ul class="space-y-2 pb-2">
                            ...
                            <li>
                                <a href="<?= base_url('admin/dashboard') ?>" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                                <img class="h-10 w-10 rounded-full" src="https://themewagon.github.io/windster/images/users/neil-sims.png" alt="Neil Sims avatar">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                                <img class="h-10 w-10 rounded-full" src="https://themewagon.github.io/windster/images/users/roberta-casas.png" alt="Roberta Casas avatar">
                                                <div class="text-sm font-normal text-gray-500">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                                <img class="h-10 w-10 rounded-full" src="https://themewagon.github.io/windster/images/users/michael-gough.png" alt="Michael Gough avatar">
                                                <div class="text-sm font-normal text-gray-500">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                                <img class="h-10 w-10 rounded-full" src="https://themewagon.github.io/windster/images/users/jese-leos.png" alt="Jese Leos avatar">
                                                <div class="text-sm font-normal text-gray-500">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                                <img class="h-10 w-10 rounded-full" src="https://themewagon.github.io/windster/images/users/bonnie-green.png" alt="Bonnie Green avatar">
                                                <div class="text-sm font-normal text-gray-500">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                                <img class="h-10 w-10 rounded-full" src="https://themewagon.github.io/windster/images/users/thomas-lean.png" alt="Thomas Lean avatar">
                                                <div class="text-sm font-normal text-gray-500">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                                <img class="h-10 w-10 rounded-full" src="https://themewagon.github.io/windster/images/users/helene-engels.png" alt="Helene Engels avatar">
                                                <div class="text-sm font-normal text-gray-500">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                                <img class="h-10 w-10 rounded-full" src="https://themewagon.github.io/windster/images/users/lana-byrd.png" alt="Lana Byrd avatar">
                                                <div class="text-sm font-normal text-gray-500">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                                <img class="h-10 w-10 rounded-full" src="https://themewagon.github.io/windster/images/users/leslie-livingston.png" alt="Leslie Livingston avatar">
                                                <div class="text-sm font-normal text-gray-500">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                                <img class="h-10 w-10 rounded-full" src="https://themewagon.github.io/windster/images/users/robert-brown.png" alt="Robert Brown avatar">
                                                <div class="text-sm font-normal text-gray-500">
