...
<head>
    ...
    <title>Dashboard | SMK INFORMATIKA ALHILAAL KAMAL</title>
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="<?= base_url('admin/dashboard') ?>" class="text-xl font-bold flex items-center lg:ml-2.5">
                        <img src="<?= base_url('assets/img/logo_terbaru1.png') ?>" class="h-6 mr-2" alt="Windster Logo">
                        <span class="self-center whitespace-nowrap">SMK INFORMATIKA ALHILAAL KAMAL</span>
                    </a>
                ...
                <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                    <div class="flex-1 px-3 bg-white divide-y space-y-1">
                        <ul class="space-y-2 pb-2">
                            ...
                            <li>
                                <a href="<?= base_url('admin/galeri') ?>" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
