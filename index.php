...
<body>
    ...
    <!-- Navbar -->
    <header
        class="ic-navbar absolute left-10 top-0 z-40 flex w-full items-center bg-transparent py-2"
        role="banner"
        aria-label="Navigation bar">
        <div class="container flex justify-between">
            <div
                class="ic-navbar-container relative flex items-center justify-center">
                <div class="flex w-full items-center justify-center px-8">
                    <div>
                        <button
                            type="button"
                            class="ic-navbar-toggler absolute right-4 top-1/2 block -translate-y-1/2 rounded-md px-3 py-[10px] text-[22px]/none text-primary-color ring-primary focus:ring-2 lg:hidden"
                            data-web-toggle="navbar-collapse"
                            data-web-target="navbarMenu"
                            aria-expanded="false"
                            aria-label="Toggle navigation menu"
                            onclick="const menu = document.getElementById('navbarMenu'); menu.classList.toggle('hidden'); this.querySelector('i').classList.toggle('lni-menu'); this.querySelector('i').classList.toggle('lni-close');">
                            <i class="lni lni-menu"></i>
                        </button>

                        <nav
                            id="navbarMenu"
                            class="ic-navbar-collapse fixed inset-0 z-50 hidden bg-primary-light-1 py-5 shadow-lg dark:bg-primary-dark-1 lg:static lg:block lg:w-full lg:max-w-full lg:bg-transparent lg:py-0 lg:shadow-none dark:lg:bg-transparent xl:px-6">
                            <ul
                                class="block lg:flex"
                                role="menu"
                                ...
                                <li class="group relative">
                                    <a
                                        ...
                                        role="menuitem"
                                        onclick="document.getElementById('navbarMenu').classList.add('hidden'); document.querySelector('.ic-navbar-toggler i').classList.add('lni-menu'); document.querySelector('.ic-navbar-toggler i').classList.remove('lni-close');">Home</a>
                                </li>
                                ...
                                <li class="group relative">
                                    <a
                                        ...
                                        role="menuitem"
                                        onclick="document.getElementById('navbarMenu').classList.add('hidden'); document.querySelector('.ic-navbar-toggler i').classList.add('lni-menu'); document.querySelector('.ic-navbar-toggler i').classList.remove('lni-close');">Visi & Misi</a>
                                </li>
                                ...
                                <li class="group relative">
                                    <a
                                        ...
                                        class="ic-page-scroll mx-8 flex py-2 text-base font-medium text-body-light-12 group-hover:text-primary dark:text-body-dark-12 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-primary-color lg:dark:text-primary-color lg:group-hover:text-primary-color lg:group-hover:opacity-70"
                                        role="menuitem"
                                        onclick="document.getElementById('navbarMenu').classList.add('hidden'); document.querySelector('.ic-navbar-toggler i').classList.add('lni-menu'); document.querySelector('.ic-navbar-toggler i').classList.remove('lni-close');">Jurusan</a>
                                </li>
                                ...
                                <li class="group relative">
                                    <a
                                        ...
                                        class="ic-page-scroll mx-8 flex py-2 text-base font-medium text-body-light-12 group-hover:text-primary dark:text-body-dark-12 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-primary-color lg:dark:text-primary-color lg:group-hover:text-primary-color lg:group-hover:opacity-70"
                                        role="menuitem"
                                        onclick="document.getElementById('navbarMenu').classList.add('hidden'); document.querySelector('.ic-navbar-toggler i').classList.add('lni-menu'); document.querySelector('.ic-navbar-toggler i').classList.remove('lni-close');">Galeri</a>
                                </li>
                                ...
                                <li class="group relative">
                                    <a
                                        ...
                                        class="ic-page-scroll mx-8 flex py-2 text-base font-medium text-body-light-12 group-hover:text-primary dark:text-body-dark-12 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-primary-color lg:dark:text-primary-color lg:group-hover:text-primary-color lg:group-hover:opacity-70"
                                        role="menuitem"
                                        onclick="document.getElementById('navbarMenu').classList.add('hidden'); document.querySelector('.ic-navbar-toggler i').classList.add('lni-menu'); document.querySelector('.ic-navbar-toggler i').classList.remove('lni-close');">Kontak</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
        ...
        <div class="flex items-center justify-end pr-[52px] lg:pr-10">
            <button
                type="button"
    ...
    <main class="main relative">
                ...
                <div class="-mx-5 flex flex-wrap items-center">
                    <div class="w-full px-5">
                        <div class="scroll-revealed mx-auto max-w-[780px] text-center">
                            <h1
                                style="font-family: 'Overlock', sans-serif;"
                                class="mb-6 text-3xl font-bold leading-snug text-primary-color sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-tight">
                                SMK Informatika Al Hilaal Kamal
                            </h1>

                            <blockquote class="mx-auto mb-9 max-w-[600px] text-base text-primary-color sm:text-lg sm:leading-normal bg-gray-50 p-6 rounded-lg border-l-4 border-blue-500 italic" style="font-family: Playfair, 'Times New Roman', Times, serif;">
                                <p class="mb-4 italic text-base text-primary-color sm:text-lg sm:leading-normal">
                                    "Manfaatkan teknologi masa depan untuk meningkatkan kualitas pendidikan di Indonesia jadilah generasi muda yang mandiri dan inovatif."
                                </p>
                            </blockquote>
        ...
        <!-- visi-misi section -->
        <section id="visi-misi" class="section-area">
            <div class="container">
                <div class="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:gap-x-12">

                    <div class="w-full">
                        <figure class="scroll-revealed max-w-[480px] mx-auto mb-8 lg:mb-0">
                            <img
                                src="<?= base_url('assets/img/logo-new.jpg'); ?>"
                                alt="Logo Yayasan"
                    ...
                    <div class="w-full lg:mt-0">
                        <div class="scroll-revealed">
                            ...
                            <p class="mb-6">
                                "Visi memberi gambaran masa depan, misi mewujudkannya dalam kerja nyata—karena harapan butuh aksi untuk menjadi kenyataan."
                            </p>
                        </div>
                        ...
                        <div class="tabs scroll-revealed">
                            ...
                            <div
                                ...
                                <p style="font-size: 1.125rem; line-height: 2rem;">
                                    Memberi gambaran masa depan yang inspiratif dan berkelanjutan bagi seluruh warga sekolah, menciptakan lingkungan pendidikan yang unggul,
                                    inovatif, dan berorientasi pada perkembangan global.
                                </p>
                                <p>
                                    <i>"Melihat masa depan cerah, membentuk generasi unggul dengan inovasi dan kepemimpinan".</i>
                                </p>
                            </div>
                            ...
                            <div
                                ...
                                <p style="font-size: 1.125rem; line-height: 2rem;">
                                    Mewujudkannya dalam kerja nyata melalui pengembangan kurikulum yang relevan, pembinaan karakter berbasis nilai,
                                    serta peningkatan kompetensi guru dan siswa, karena harapan butuh aksi nyata untuk menjadi kenyataan.
                                </p>
                                <p>
                                    <i>"Mewujudkan harapan melalui aksi nyata, kurikulum relevan, dan pembinaan karakter siswa."</i>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Services section -->
        <section id="jurusan" class="section-area">
            <div class="container">
                <div class="scroll-revealed text-center max-w-[550px] mx-auto mb-12">
                    <h6 class="mb-2 block text-lg font-semibold text-primary">
                        Jurusan
                    </h6>
                    <h2 class="mb-6">Jurusan Unggulan</h2>
                    <p>
                        Berikut adalah jurusan yang tersedia di SMK kami yang siap mencetak lulusan siap kerja dan berdaya saing tinggi.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="scroll-revealed">
                        <div class="group hover:-translate-y-1 mb-8">
                            <div
                            ...
                            <div class="w-full">
                                ...
                                <p>
                                    RPL adalah proses terstruktur dan sistematis untuk membangun perangkat lunak yang berfungsi dengan baik dan memenuhi kebutuhan pengguna.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="scroll-revealed">
                        <div class="group hover:-translate-y-1 mb-8">
                            ...
                            <div class="w-full">
                                <h4 class="text-[1.25rem]/tight font-semibold mb-5">
                                    TKJ (Teknologi Komputer dan Jaringan)
                                </h4>
                                <p>
                                    Teknik Komputer dan Jaringan, sebuah jurusan di Sekolah Menengah Kejuruan (SMK) yang berfokus pada pemahaman dan penerapan teknologi informasi dan komunikasi,
                                    khususnya dalam bidang komputer dan jaringan.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="scroll-revealed">
                        <div class="group hover:-translate-y-1 mb-8">
                            ...
                            <div class="w-full">
                                ...
                                <p>
                                    Desain Komunikasi Visual (DKV). Jurusan ini membekali siswa dengan keterampilan desain grafis,
                                    termasuk desain antarmuka (UI) dan pengalaman pengguna (UX) untuk produk digital seperti aplikasi dan website.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <section id="gallery" class="section-area">
            <div class="container">
                <div class="scroll-revealed text-center max-w-[550px] mx-auto mb-12">
                    <h6 class="mb-2 block text-lg font-semibold text-primary">
                        Foto Kegiatan SMK Informatika Al-hilaal Kamal
                    </h6>
                    <h2 class="mb-6">Gallery Terbaru</h2>
                    <p>
                        Gambar atau foto kegiatan di SMK Informatika Al Hilaal Kamal yang menunjukkan berbagai aktivitas dan prestasi siswa.
                    </p>
                </div>
                        ...
                        <article class="group" data-filter="branding">
                            ...
                            <div class="pt-4">
                                <h4 class="mb-2">
                                    <a
                                        href="javascript:void(0)"
                                        class="text-[1.5rem] leading-tight text-inherit">Graphics Design</a>
                                </h4>
                                <p>
                        ...
                        <article class="group" data-filter="research">
                            ...
                            <div class="pt-4">
                                <h4 class="mb-2">
                                    <a
                                        href="javascript:void(0)"
                                        class="text-[1.5rem] leading-tight text-inherit">Web Development</a>
                                </h4>
                                <p>
                                    Short description for the ones who look for something new.
                                    Awesome!
                        ...
                        <article class="group" data-filter="marketing">
                            ...
                            <div class="pt-4">
                                <h4 class="mb-2">
                                    <a
                                        href="javascript:void(0)"
                                        class="text-[1.5rem] leading-tight text-inherit">App Development</a>
                                </h4>
                                <p>
                                    Short description for the ones who look for something new.
                                    Awesome!
                        ...
                        <article class="group" data-filter="planning">
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex flex-wrap gap-2 p-4">
                                        <div class="inline-block relative">
                                            <a
                                                href="./assets/img/portfolio/foto3.jpg"
                                                class="portfolio-box text-[1.75rem] text-primary-color bg-primary z-10 w-[60px] aspect-square rounded-lg text-center inline-flex items-center justify-center hover:bg-primary-light-10 hover:text-primary-color dark:hover:bg-primary-dark-10 dark:hover:text-primary-color focus:bg-primary-light-10 focus:text-primary-color dark:focus:bg-primary-dark-10 dark:focus:text-primary-color">
                                                <i class="lni lni-zoom-in"></i>
                                            </a>
                                        </div>
                            ...
                            <div class="pt-4">
                                <h4 class="mb-2">
                                    <a
                                        href="javascript:void(0)"
                                        class="text-[1.5rem] leading-tight text-inherit">MPLS 1</a>
                                </h4>
                                <p>
                                    Pengenalan materi singkat tentang Informatika 1
                                </p>
                            </div>
                        </article>
                    </div>
                        ...
                        <article class="group" data-filter="planning">
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex flex-wrap gap-2 p-4">
                                        <div class="inline-block relative">
                                            <a
                                                href="./assets/img/portfolio/foto1.jpg"
                                                class="portfolio-box text-[1.75rem] text-primary-color bg-primary z-10 w-[60px] aspect-square rounded-lg text-center inline-flex items-center justify-center hover:bg-primary-light-10 hover:text-primary-color dark:hover:bg-primary-dark-10 dark:hover:text-primary-color focus:bg-primary-light-10 focus:text-primary-color dark:focus:bg-primary-dark-10 dark:focus:text-primary-color">
                                                <i class="lni lni-zoom-in"></i>
                                            </a>
                                        </div>
                            ...
                            <div class="pt-4">
                                <h4 class="mb-2">
                                    <a
                                        href="javascript:void(0)"
                                        class="text-[1.5rem] leading-tight text-inherit">MPLS 2</a>
                                </h4>
                                <p>
                                    Pengenalan materi singkat tentang Informatika 2
                                </p>
                            </div>
                        </article>
                    </div>
                        ...
                        <article class="group" data-filter="planning">
                            ...
                            <div class="pt-4">
                                <h4 class="mb-2">
                                    <a
                                        href="javascript:void(0)"
                                        class="text-[1.5rem] leading-tight text-inherit">MPLS 3</a>
                                </h4>
                                <p>
                                    Pengenalan materi singkat tentang Informatika 3
                                </p>
                            </div>
                        </article>
                    </div>
                        ...
                        <article class="group" data-filter="branding">
                            ...
                            <div class="pt-4">
                                <h4 class="mb-2">
                                    <a
                                        href="javascript:void(0)"
                                        class="text-[1.5rem] leading-tight text-inherit">SEO Services</a>
                                </h4>
                                <p>
                                    Short description for the ones who look for something new.
                                    Awesome!
                        ...
                        <article class="group" data-filter="marketing">
                            ...
                            <div class="pt-4">
                                <h4 class="mb-2">
                                    <a
                                        href="javascript:void(0)"
                                        class="text-[1.5rem] leading-tight text-inherit">Product Design</a>
                                </h4>
                                <p>
                                    Short description for the ones who look for something new.
                                    Awesome!
                    ...
                    <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                        <div
                            ...
                            <div class="pt-8 pb-10">
                                <a
                                    href="javascript:void(0)"
                                    class="inline-block font-medium px-6 py-3 rounded-md bg-primary/10 text-primary hover:bg-primary hover:text-primary-color focus:bg-primary focus:text-primary-color">Start Free Trial</a>
                            </div>
                            <div>
                                <ul>
                                    <li
                                        ...
                                        <i
                                            class="lni lni-checkmark-circle text-primary text-base leading-[24px]"></i>
                    ...
                    <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                        <div
                            ...
                            <div class="pt-8 pb-10">
                                <a
                                    href="javascript:void(0)"
                                    class="inline-block font-medium px-6 py-3 rounded-md bg-primary text-primary-color hover:bg-primary-light-10 dark:hover:bg-primary-dark-10 hover:text-primary-color focus:bg-primary-light-10 dark:focus:bg-primary-dark-10 focus:text-primary-color">Purchase Now</a>
                            </div>
                            <div>
                                <ul>
                                    <li
                    ...
                    <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                        <div
                            ...
                            <div class="pt-8 pb-10">
                                <a
                                    href="javascript:void(0)"
                                    class="inline-block font-medium px-6 py-3 rounded-md bg-primary/10 text-primary hover:bg-primary hover:text-primary-color focus:bg-primary focus:text-primary-color">Purchase Now</a>
                            </div>
                            <div>
                                <ul>
                                    <li
                ...
                <div class="row">
                    <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                        <article class="group">
                            ...
                            <span
                                class="block mt-6 w-full text-sm text-body-light-10 dark:text-body-dark-10">Joe Russell - 17 Agt 2024</span>
                            <h4 class="mb-6 mt-3 font-semibold text-[1.5rem]">
                                <a
                                    href="javascript:void(0)"
                                    class="text-body-light-12 dark:text-body-dark-12">Make your team a Design driven company</a>
                            </h4>
                            <p>
                    ...
                    <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                        <article class="group">
                            ...
                            <h4 class="mb-6 mt-3 font-semibold text-[1.5rem]">
                                <a
                                    href="javascript:void(0)"
                                    class="text-body-light-12 dark:text-body-dark-12">The newest web framework that changed the world</a>
                            </h4>
                            <p>
                                Lorem Ipsum is simply dummy text of the printing and
                                typesetting industry. Lorem Ipsum has been the industry's
                    ...
                    <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
                        <article class="group">
                            ...
                            <h4 class="mb-6 mt-3 font-semibold text-[1.5rem]">
                                <a
                                    href="javascript:void(0)"
                                    class="text-body-light-12 dark:text-body-dark-12">5 ways to improve user retention for your startup</a>
                            </h4>
                            <p>
                                Lorem Ipsum is simply dummy text of the printing and
                                typesetting industry. Lorem Ipsum has been the industry's
        ...
        <section id="contact" class="section-area">
            <div class="container">
                <div class="scroll-revealed text-center max-w-[550px] mx-auto mb-12">
                    <h6 class="mb-2 block text-lg font-semibold text-primary">Kontak</h6>
                    <p>
        ...
        <!-- Map section -->
        <section id="map" class="w-full h-[500px] overflow-hidden -mt-[50rem]">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1991.7730813674295!2d128.2793342394314!3d-3.2131164239488905!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2d6c405e0e41d39d%3A0x749c5f032f274847!2sMasjid%20Al%20Hilaal!5e0!3m2!1sen!2sid!4v1754012582164!5m2!1sen!2sid"
            ...
            <div class="flex flex-wrap">
                <!-- <div class="w-full md:w-1/2">
                    <div class="my-1">
                        <div
                            ...
                            <a
                                href="javascript:void(0)"
                                class="text-body-dark-11 hover:text-body-dark-12">Privacy Policy</a>
                            <a
                                href="javascript:void(0)"
                                class="text-body-dark-11 hover:text-body-dark-12">Legal Notice</a>
                            <a
                                href="javascript:void(0)"
                                class="text-body-dark-11 hover:text-body-dark-12">Terms of Service</a>
                        </div>
                    </div>
                </div> -->
                ...
                <div class="w-full md:w-1/2">
                    <div class="my-1 flex justify-center md:justify-end">
                        <p class="text-body-dark-11">
                            &#169; 2025 SMK INFORMATIKA ALHILAAL KAMAL. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
